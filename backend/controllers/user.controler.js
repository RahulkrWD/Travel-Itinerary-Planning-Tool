...
const getUser = async (req, res) => {
    try {
      ...
      const user = await userModel.findById(userId).select("-_id -password -role");
      res.status(200).json({
...
const updateAddress = async (req, res) => {
  ...
  module.exports = {getUser, addAddress, deleteAddress, updateAddress, updateUser, getAddress};
